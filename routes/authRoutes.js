...
    // Incluir current_population en la inserción y retorno
        const newUser = await pool.query(
            'INSERT INTO users (username, password, current_population, last_resource_update,x_coord, y_coord) VALUES ($1, $2, $3, $4, $5, $6) RETURNING id, username, wood, stone, food, current_population, last_resource_update, x_coord, y_coord',
